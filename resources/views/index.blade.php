    ...
    <div class="containerw3layouts-agileits">
        ...
        <div id="verticalTab" class="resp-vtabs w3-agile" style="display: block; width: 100%; margin: 0px;">
            ...
            <ul class="resp-tabs-list agileits-w3layouts">
                ...
                <li class="resp-tab-item"><span>TECRÜBELERİM</span></li>
                <li class="resp-tab-item agileinfo"><span>EĞİTİMİM</span></li>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="li3"><a class="mail"
                                            href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=new ">{{ $about->email }}</a></div>
                                    <div class="clearfix"></div>
                                </li>
                                <li>
                    ...
                    <div class="our-skills">
                        @foreach ($skills as $s)
                            <div class="single-skill">
                                ...
                                <div class="progress">
                                    <div class="progress-bar progress-bar-1" style="width: {{ $s->skills_percent }}%;">
                                        %{{ $s->skills_percent ?? '------------' }}</div>
                                </div>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="social-icons w3layouts agileits">
                        ...
                        <ul>
                            @foreach ($contact as $con)
                                <li class="fb w3ls w3layouts agileits">
                                    <a href="{{$con->social_url}}">
                                        <span class="icons w3layouts agileits"></span>
                                        <span class="text w3layouts agileits">{{ $con->social_name }}</span>
                                    </a>
                                </li>
                            @endforeach
                        </ul>
